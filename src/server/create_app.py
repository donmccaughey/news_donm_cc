...
from .views import get_home_response, get_numbered_news_response, get_site_response, get_sites_response
...
def create_app() -> Flask:
    ...
    app.add_url_rule(
        ...
        partial(
            get_numbered_news_response, cached_news, version, is_styled
        ),
        methods=['GET']
    )
    app.add_url_rule(
